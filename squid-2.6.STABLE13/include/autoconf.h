...
#define SQUID_CONFIGURE_OPTIONS "'--sysconfdir=/etc/squid' '--enable-err-languages=Portuguese' '--enable-default-err-language=Portuguese' '--enable-delay-pools' '--enable-storeio=diskd aufs coss ufs' '--enable-cache-digests--enable-poll' '--disable-ident-lookups' '--enable-truncate' '--enable-removal-policies' '--enable-arp-acl'"
